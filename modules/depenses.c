...
//             printf("║    %2s → %2s \033[1;36m%s\033[0m     ║\n", jour_debut, jour_fin, mois_annee_only); 
...
//                     printf("  \033[1;90m%s %s\033[0m → \033[1;33m%6.2f\033[0m dhs\n", date_fmt, heure_fmt, montant);
//                     total += montant;
//                     depenses_trouvees++;
//                 }
//             }
...
//             printf("║           💰 SYNTHESE            ║\n");
//             printf("╠══════════════════════════════════╣\n");
//             printf("║ Nombre   : %4d dépenses        ║\n", depenses_trouvees);
//             printf("║ Total    : \033[1;32m%8.2f\033[0m dhs       ║\n", total);
//             printf("╚══════════════════════════════════╝\n");
//         }
...
//         do {
//             printf("\n╔══════════════════════════════════════════╗\n");
//             printf("║ 🕐 NAVIGATION SEMANES                    ║\n");
//             printf("╠══════════════════════════════════════════╣\n");
//             printf("║ 1. Précédente  │ 2. Actuelle │ 3. Suivante ║\n");
